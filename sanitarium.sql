...
CREATE TABLE PATIENT (PATIENT_NUMBER INT NOT NULL,FIRSTNAME VARCHAR(50) NOT NULL,LASTNAME VARCHAR(50) NOT NULL,ADDRESS VARCHAR(100) NULL,TELNUMBER INT NOT NULL,BIRTHDATE DATE NOT NULL,SEX VARCHAR(8) NOT NULL,MARITAL_STATUS VARCHAR(10) NOT NULL)
